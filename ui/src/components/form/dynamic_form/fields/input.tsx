...
import { InputFieldPropsBase, DateInputFieldProps, InputFieldProps } from '../../types'
...
const TextInputField: React.FC<PropsWithChildren<InputFieldPropsBase>> = ({
    ...
    return (
        ...
        >
            {({ defaultValue, disabled, readonly, onChange}) => (
                <Input fluid type={type} readOnly={readonly} disabled={disabled} value={ value ?? defaultValue } onChange={(_e, {value}) => onChange(field, value)}/>
            )}
        </FormField>
    )
}
...
const DateInputField: React.FC<PropsWithChildren<DateInputFieldProps>> = ({
    ...
    useEffect(() => {
        if (formWasCleared && selectedDate !== null) {
                ...
                <>
                    ...
                    <DatePicker
                        ...
                        onChange={(date: Date|null) => {
                            ...
                            onChange(field, date ? JSON.stringify({
                                value: date,
